...
VALUES 
('Product 1', 'Product 1 description', 1000, 'c100', '/images/product1.png', NOW(), 'admin', NOW(), 'admin'),
('Product 2', 'Product 2 description', 2000, 'c200', '/images/product2.png', NOW(), 'admin', NOW(), 'admin'),
('Product 3', 'Product 3 description', 3000, 'c300', '/images/product3.png', NOW(), 'admin', NOW(), 'admin'),
('Product 4', 'Product 4 description', 4000, 'c400', '/images/product4.png', NOW(), 'admin', NOW(), 'admin'),
('Product 5', 'Product 5 description', 5000, 'c100', '/images/product5.png', NOW(), 'admin', NOW(), 'admin'),
('Product 6', 'Product 6 description', 6000, 'c200', '/images/product6.png', NOW(), 'admin', NOW(), 'admin'),
('Product 7', 'Product 7 description', 7000, 'c300', '/images/product7.png', NOW(), 'admin', NOW(), 'admin'),
('Product 8', 'Product 8 description', 8000, 'c400', '/images/product8.png', NOW(), 'admin', NOW(), 'admin'),
('Product 9', 'Product 9 description', 9000, 'c100', '/images/product9.png', NOW(), 'admin', NOW(), 'admin'),
('Product 10', 'Product 10 description', 10000, 'c200', '/images/product10.png', NOW(), 'admin', NOW(), 'admin'),
('Product 11', 'Product 11 description', 11000, 'c300', '/images/product11.png', NOW(), 'admin', NOW(), 'admin'),
('Product 12', 'Product 12 description', 12000, 'c400', '/images/product12.png', NOW(), 'admin', NOW(), 'admin'),
('Product 13', 'Product 13 description', 13000, 'c100', '/images/product13.png', NOW(), 'admin', NOW(), 'admin'),
('Product 14', 'Product 14 description', 14000, 'c200', '/images/product14.png', NOW(), 'admin', NOW(), 'admin'),
('Product 15', 'Product 15 description', 15000, 'c300', '/images/product15.png', NOW(), 'admin', NOW(), 'admin'),
('Product 16', 'Product 16 description', 16000, 'c400', '/images/product16.png', NOW(), 'admin', NOW(), 'admin'),
('Product 17', 'Product 17 description', 17000, 'c100', '/images/product17.png', NOW(), 'admin', NOW(), 'admin'),
('Product 18', 'Product 18 description', 18000, 'c200', '/images/product18.png', NOW(), 'admin', NOW(), 'admin'),
('Product 19', 'Product 19 description', 19000, 'c300', '/images/product19.png', NOW(), 'admin', NOW(), 'admin'),
('Product 20', 'Product 20 description', 20000, 'c400', '/images/product20.png', NOW(), 'admin', NOW(), 'admin');
-- ATTACHMENT 데이터 삽입
...
VALUES 
(1, 'original1.jpg', 'saved1.jpg', '/images/saved1', '/images/thumbnail1', NOW(), 'admin', NOW(), 'admin'),
(2, 'original2.jpg', 'saved2.jpg', '/images/saved2', '/images/thumbnail2', NOW(), 'admin', NOW(), 'admin'),
(3, 'original3.jpg', 'saved3.jpg', '/images/saved3', '/images/thumbnail3', NOW(), 'admin', NOW(), 'admin');
